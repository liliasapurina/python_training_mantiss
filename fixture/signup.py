...
class SignupHelper:
    ...
    def new_user(self, username, email, password):
        ...
        wd.find_element_by_name("username").sendKeys(username)
        wd.find_element_by_name("email").sendKeys(email)
        ...
        wd.get(url)
        wd.find_element_by_name("password").sendKeys(password)
        wd.find_element_by_name("password_confirm").sendKeys(password)
